...
import type { NulGenerator } from './generator'
...
export interface RuleContext<Theme extends {} = {}> {
    ...
    /**
     * NulCSS generator instance
     */
    generator: NulGenerator
    /**
     * The theme object
     */
    theme: Theme
...
export interface NulcssPluginContext<Config extends UserConfig = UserConfig> {
...
export interface SourceCodeTransformer {
     ...
     */
    transform: (code: MagicString, id: string, ctx: NulcssPluginContext) => Awaitable<void>
}
